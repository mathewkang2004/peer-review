...
plan.data.2012 <- as_tibble(plan.year)
...
service.data.2012 <- service.year %>%
...
ma.path.a <- "/home/salizad/econ470/a0/work/ma-data/ma/star-ratings/Extracted Star Ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Star.csv"
...
ma.path.b <- "/home/salizad/econ470/a0/work/ma-data/ma/star-ratings/Extracted Star Ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Summary.csv"
...
bench.data <- read_csv("/home/salizad/econ470/a0/work/ma-data/ma/benchmarks/ratebook2012/CountyRate2012.csv",
                       skip=9,
                       col_names=c("ssa","state","county_name","risk_star5",
                                   "risk_star45","risk_star4","risk_star35",
                                   "risk_star3","risk_star25","esrd_ab"))

bench.data.2012 <- bench.data %>%
...
ma.2012 <- plan.data.2012 %>%
  ...
  left_join(bench.data.2012 %>% filter(!is.na(ssa)) %>%
...
# Save to CSV
output_path <- "../data/output/data-2012.csv"

# Create parent directories if they don't exist
dir.create(dirname(output_path), recursive = TRUE, showWarnings = FALSE)

# Write CSV
write_csv(ma.2012, output_path)

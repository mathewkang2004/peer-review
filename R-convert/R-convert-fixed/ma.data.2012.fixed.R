...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Star.csv"
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Summary.csv"
...
bench.data <- read_csv("data/input/ma/benchmarks/ratebook2012/CountyRate2012.csv",
                       skip=9,

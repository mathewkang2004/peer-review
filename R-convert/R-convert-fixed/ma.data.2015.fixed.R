...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_stars.csv"
star.data.a <- fread(
  ma.path.a,
  skip = 4,
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_summary.csv"
star.data.b <- fread(
  ma.path.b,
  skip = 2,
  stringsAsFactors=FALSE, 
...
bench.data <- read_csv("data/input/ma/benchmarks/ratebook2015/CSV/CountyRate2015.csv",
                       skip=3,

...
plan.data.2013 <- as_tibble(plan.year)
...
service.data.2013 <- service.year %>%
...
ma.path.a <- "/home/salizad/econ470/a0/work/ma-data/ma/star-ratings/Extracted Star Ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Star.csv"
...
ma.path.b <- "/home/salizad/econ470/a0/work/ma-data/ma/star-ratings/Extracted Star Ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Summary.csv"
...
ma.2013 <- plan.data.2013 %>%
  ...
  left_join(bench.data.2013 %>% filter(!is.na(ssa)) %>%
